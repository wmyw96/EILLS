...
from methods.eills_gumbel import eills_sgd_gumbel
...
# EILLS Gumbel algorithm
niters = args.niters
iter_save = 100
packs = eills_sgd_gumbel(xs, ys, hyper_gamma=args.gamma, learning_rate=args.lr, niters_d=args.diter,
